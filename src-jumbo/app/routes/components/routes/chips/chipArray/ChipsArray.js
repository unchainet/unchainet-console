...
class ChipsArray extends Component {
    state = {
        chipData: [
            ...
            {key: 2, name: 'Stella Johnson', image: 'http://via.placeholder.com/120x120'},
            {key: 3, name: 'Alex Dolgove', image: 'http://via.placeholder.com/128x128'},
            {key: 4, name: 'John Smith', image: 'http://via.placeholder.com/210x210'},
        ],
    };
