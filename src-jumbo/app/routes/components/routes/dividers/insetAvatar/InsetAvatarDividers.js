...
function InsetAvatarDividers() {
    return (
        <List>
            ...
            <Divider inset />
            <ListItem button>
                <Avatar className="size-50" alt="Adelle Charles" src="http://via.placeholder.com/260x260"/>
            ...
            <Divider inset />
            <ListItem button>
                <Avatar className="size-50" alt="Remy Sharp" src="http://via.placeholder.com/120x120"/>
