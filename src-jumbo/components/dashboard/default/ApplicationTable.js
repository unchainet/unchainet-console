...
class AssignmentTable extends Component {
    state = {
        data: [
            createData('Saans Application', 'Renewal', 'http://via.placeholder.com/210x210', '6:06', '$54.20'),
            createData('Chatbull Application', 'Support', 'http://via.placeholder.com/128x128', '9:20', '$25.12'),
            createData('Teri App', 'It was popularised in the 1960s with the', 'http://via.placeholder.com/210x210', '4:30', '$15.99'),
            ...
            createData('Wallet Application', 'Renewal, a Latin professor', 'http://via.placeholder.com/120x120', '7:50', '$3.10'),
