...
class OrderTable extends Component {
    state = {
        data: [
            createData('23545', 'Alex Dolgove', 'http://via.placeholder.com/128x128', '25 Oct', '25 Oct', 'Completed'),
            createData('23653', 'Domnic Brown', 'http://via.placeholder.com/210x210', '28 Oct', '1 Nov', 'On Hold'),
            createData('24567', 'Garry Sobars', 'http://via.placeholder.com/150x150', '5 Nov', '10 Nov', 'Delayed'),
            createData('25745', 'Stella Johnson', 'http://via.placeholder.com/120x120', '23 Nov', '26 Nov', 'Cancelled'),
        ],
    };
