export default [
    {
        id: 1,
        name: 'Alex Dolgove',
        thumb: 'http://via.placeholder.com/128x128',
        status: 'away',
        ...
        id: 2,
        name: 'Domnic Brown',
        thumb: 'http://via.placeholder.com/210x210',
        status: 'online',
        mood: 'English versions from the 1914 translation by H. Rackham',
        ...
        id: 9,
        name: 'Jimmy Jon',
        thumb: 'http://via.placeholder.com/260x260',
        status: 'offline',
        mood: 'There are many variations of passages of ',
        lastMessage: 'There are many variations of passages of ',
        unreadMessage: '',
        ...
        id: 10,
        name: 'Stella Johnson',
        thumb: 'http://via.placeholder.com/120x120',
        status: 'offline',
        mood: 'It is a long established fact',
        lastMessage: 'English versions from the 1914 translation by H. Rackham',
        unreadMessage: '',
