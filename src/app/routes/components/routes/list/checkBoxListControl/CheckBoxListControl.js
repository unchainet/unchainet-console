...
const users = [
    ...
    {id: 2, image: 'http://via.placeholder.com/120x120', email: 'stella02@example.com'},
    {id: 3, image: 'http://via.placeholder.com/150x150', email: 'chrris@example.com'},
    {id: 4, image: 'http://via.placeholder.com/260x260', email: 'jhonson@example.com'},
    {id: 5, image: 'http://via.placeholder.com/210x210', email: 'domnic@example.com'}];
